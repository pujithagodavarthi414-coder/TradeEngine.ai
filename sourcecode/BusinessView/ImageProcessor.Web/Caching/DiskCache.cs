    ...
    public class DiskCache : ImageCacheBase
    {
                    ...
                    foreach (DirectoryInfo directory in directories)
                    {
                        ...
                        foreach (FileInfo fileInfo in files)
                        {
                            ...
                            catch (Exception exception)
                            {
                                ...
                                ImageProcessorBootstrapper.Instance.Logger.Log<DiskCache>($"Unable to clean cached file: {fileInfo.FullName}, {exception}");
                            }
                        }
        ...
        private void RecursivelyDeleteEmptyDirectories(DirectoryInfo directory, DirectoryInfo root, CancellationToken token)
        {
            ...
            catch (Exception exception)
            {
                ...
                ImageProcessorBootstrapper.Instance.Logger.Log<DiskCache>($"Unable to clean cached directory: {directory.FullName}, {exception}");
