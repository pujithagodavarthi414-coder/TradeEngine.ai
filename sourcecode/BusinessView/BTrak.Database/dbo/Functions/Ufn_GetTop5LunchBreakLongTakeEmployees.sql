CREATE  FUNCTION [dbo].[Ufn_GetTop5LunchBreakLongTakeEmployees]
(
...
BEGIN
    ...
    SELECT U.Id,ISNULL(FirstName,'') + ' ' + ISNULL(SurName,'') FullName,Ts.[Date],SWITCHOFFSET(LunchBreakStartTime, '+00:00'),SWITCHOFFSET(LunchBreakEndTime, '+00:00'),LateTime,
