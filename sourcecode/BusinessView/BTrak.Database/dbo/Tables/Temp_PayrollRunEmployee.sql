CREATE  TABLE [dbo].[Temp_PayrollRunEmployee](
    ...
    CONSTRAINT [PK_Temp_PayrollRunEmployee] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
ALTER TABLE [dbo].[Temp_PayrollRunEmployee]  WITH NOCHECK ADD CONSTRAINT [FK_Temp_PayrollRunEmployee_Temp_PayrollRun_PayrollRunId] FOREIGN KEY([PayrollRunId])
REFERENCES [dbo].[Temp_PayrollRun] ([Id])
GO

ALTER TABLE [dbo].[Temp_PayrollRunEmployee] CHECK CONSTRAINT [FK_Temp_PayrollRunEmployee_Temp_PayrollRun_PayrollRunId]
GO

ALTER TABLE [dbo].[Temp_PayrollRunEmployee]  WITH NOCHECK ADD CONSTRAINT [FK_Temp_PayrollRunEmployee_Employee_EmployeeId] FOREIGN KEY([EmployeeId])
REFERENCES [dbo].[Employee] ([Id])
GO

ALTER TABLE [dbo].[Temp_PayrollRunEmployee] CHECK CONSTRAINT [FK_Temp_PayrollRunEmployee_Employee_EmployeeId]
GO

ALTER TABLE [dbo].[Temp_PayrollRunEmployee]  WITH CHECK ADD  CONSTRAINT [FK_Temp_PayrollRunEmployee_User_CreatedByUserId] FOREIGN KEY([CreatedByUserId])
REFERENCES [dbo].[User] ([Id])
GO

ALTER TABLE [dbo].[Temp_PayrollRunEmployee] CHECK CONSTRAINT [FK_Temp_PayrollRunEmployee_User_CreatedByUserId]
GO

ALTER TABLE [dbo].[Temp_PayrollRunEmployee]  WITH CHECK ADD  CONSTRAINT [FK_Temp_PayrollRunEmployee_User_UpdatedByUserId] FOREIGN KEY([UpdatedByUserId])
REFERENCES [dbo].[User] ([Id])
GO

ALTER TABLE [dbo].[Temp_PayrollRunEmployee] CHECK CONSTRAINT [FK_Temp_PayrollRunEmployee_User_UpdatedByUserId]
GO