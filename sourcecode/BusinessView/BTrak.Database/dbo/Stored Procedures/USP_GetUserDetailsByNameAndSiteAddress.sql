--EXEC [dbo].[USP_GetUserDetailsByNameAndSiteAddress] @UserName = 'EMSTest@gmail.com',@SiteAddress = 'btrak491-development'
...
IF(@IsSupport = 1 AND @IsSupportLogin = 0)
	...
	BEGIN
		...
		WHERE U.[UserName] = @UserName AND U.CompanyId = @CompanyId
		END
	END
END
GO