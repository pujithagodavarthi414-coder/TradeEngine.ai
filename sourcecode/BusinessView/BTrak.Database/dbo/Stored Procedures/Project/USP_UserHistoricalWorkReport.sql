...
--------------------------------------------------------------------------------
--EXEC [USP_UserHistoricalWorkReport] @OperationsPerformedBy = 'f418e5ad-7430-4692-a7f5-646e6eeef842',@DateFrom = '2020-04-01',@DateTo = '2020-04-29',@IsTableView = 1
--------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[USP_UserHistoricalWorkReport]
(
