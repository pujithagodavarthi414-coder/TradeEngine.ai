...
-- Purpose      To Get userstory spent time by applying different filters
...
-------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[USP_SearchUserStorySpentTimes]
(
	    ...
	    BEGIN
            ...
            SELECT USS.Id AS UserStorySpentTimeId,
              ...
              FROM [dbo].[UserStorySpentTime] USS
                   ...
                   INNER JOIN [UserStory]US ON US.Id = USS.UserStoryId 
