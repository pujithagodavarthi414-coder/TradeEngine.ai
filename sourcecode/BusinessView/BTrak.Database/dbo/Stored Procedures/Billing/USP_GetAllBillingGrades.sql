-------------------------------------------------------------------------------
--EXEC  [dbo].[USP_GetAllBillingGrades] @OperationsPerformedBy = '127133F1-4427-4149-9DD6-B02E0E036971'
-------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[USP_GetAllBillingGrades]
(
   ...
   SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED 
	    ...
	    BEGIN
           ...
           SELECT G.Id AS GradeId,
				  ...
				  G.ProductId,
				  G.GstCode
           FROM BillingGrade AS G
				INNER JOIN [MasterProduct] P ON P.Id = G.ProductId
