CREATE PROCEDURE [dbo].[Marker389]
(
...
BEGIN
    ...
    USING ( VALUES
        (NEWID(), 'In Execution', 'In Execution', '#00D1FF', @Currentdate, @UserId,@CompanyId)
    )
	...
	VALUES(
    'PurchaseDocumentRemind','<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
</html>','Verify Documents',N'5405D797-03C8-4C82-8B4A-81EE28483071') 

        INSERT INTO @Template(EmailTemplateName,EmailTemplate,EmailSubject,EmailTemplateReferenceId)
	VALUES(
    'PurchaseRejectedEmail','<!doctype html>
<html lang="en">
...
</html>','Step Rejected Email',N'FFF480B1-49A1-4BB4-99D7-9A2FD7451EC0') 

        INSERT INTO @Template(EmailTemplateName,EmailTemplate,EmailSubject,EmailTemplateReferenceId)
	VALUES(
    'PurchaseDocumentAccepted','<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
...
<![endif]-->
              ...
              <tbody>
                ...
                <tr>
                  <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                    ...
                    <h2 class="o_heading o_text-dark o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">Documents are accepted</h2>
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                <tr>
                  <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                    ...
                    <p style="margin-top: 0px;margin-bottom: 0px;">We are pleased to inform that submitted documents are accepted. Please have a look on it. Ignore if it''s already done.</p>
                    </p>
                  </td>
                </tr>
              </tbody>
    ...
    <table class="o_block-lg" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
      <tbody></tbody>
...
</html>','Documents Accepted',N'64F06A4E-4FF1-427E-9F03-6B9EFF6733C1') 
	    ...
	    USING ( VALUES
	    	   (NEWID(), N'##CompanyLogo##',N'5405D797-03C8-4C82-8B4A-81EE28483071','This is the company logo used to show in email', @CompanyId, GETDATE(), @UserId, NULL),
	    	   (NEWID(), N'##CompanyLogo##',N'FFF480B1-49A1-4BB4-99D7-9A2FD7451EC0','This is the company logo used to show in email', @CompanyId, GETDATE(), @UserId, NULL),
	    	   (NEWID(), N'##CompanyLogo##',N'64F06A4E-4FF1-427E-9F03-6B9EFF6733C1','This is the company logo used to show in email', @CompanyId, GETDATE(), @UserId, NULL),
	    	   (NEWID(), N'##siteUrl##',N'5405D797-03C8-4C82-8B4A-81EE28483071','This is URL that''s need to redirect based on click action', @CompanyId, GETDATE(), @UserId, NULL),
	    	   (NEWID(), N'##siteUrl##',N'FFF480B1-49A1-4BB4-99D7-9A2FD7451EC0','This is URL that''s need to redirect based on click action', @CompanyId, GETDATE(), @UserId, NULL),
	    	   (NEWID(), N'##siteUrl##',N'64F06A4E-4FF1-427E-9F03-6B9EFF6733C1','This is URL that''s need to redirect based on click action', @CompanyId, GETDATE(), @UserId, NULL)
	    	) 
