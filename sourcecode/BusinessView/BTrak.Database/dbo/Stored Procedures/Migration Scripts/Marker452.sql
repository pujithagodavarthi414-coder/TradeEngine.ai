CREATE PROCEDURE [dbo].[Marker452]
(
...
SET NOCOUNT ON
	...
	DECLARE @ModuleId UNIQUEIDENTIFIER = (SELECT TOP 1 Id FROM Module WHERE Id = '4F1959A3-D114-4176-BD3C-E3F6349F1C53')
	...
	USING ( VALUES 
	 (NEWID(), @RoleId, (SELECT TOP 1 Id FROM Feature (NOLOCK) WHERE Id = '4E989026-A2ED-41EB-B426-E173D6AE2772'), GETDATE(), @UserId)
	)
