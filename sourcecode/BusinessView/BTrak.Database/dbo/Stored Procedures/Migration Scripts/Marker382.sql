CREATE PROCEDURE [dbo].[Marker382]
(
...
MERGE INTO [dbo].[ClientInvoiceStatus] AS Target 
            USING ( VALUES
		        ...
		        ,(NEWID(), 'Invoice Shared', 'Invoice Shared', '#2666CF', @Currentdate, @UserId,@CompanyId)
		        ,(NEWID(), 'Invoice Accepted', 'Invoice Accepted', '#00D1FF', @Currentdate, @UserId,@CompanyId)
		        ,(NEWID(), 'Invoice Rejected', 'Invoice Rejected', '#F05454', @Currentdate, @UserId,@CompanyId)
		        ,(NEWID(), 'Invoice Generated', 'Invoice Generated', '#76E8E0', @Currentdate, @UserId,@CompanyId)
            )
    ...
    MERGE INTO [dbo].[InvoiceQueueTradingStatus] AS Target 
            USING ( VALUES
		        (NEWID(), 'Created','Created', '#00B4D8', @Currentdate, @UserId,@CompanyId)
		        ,(NEWID(), 'In Progress','In Progress', '#2666CF', @Currentdate, @UserId,@CompanyId)
		        ,(NEWID(), 'Approved','Approved', '#06FF00', @Currentdate, @UserId,@CompanyId)
		        ,(NEWID(), 'Rejected','Rejected', '#F05454', @Currentdate, @UserId,@CompanyId)
		        ,(NEWID(), 'Paid','Paid', '#009DAE', @Currentdate, @UserId,@CompanyId)
		        ,(NEWID(), 'Disputed','Disputed', '#FF0000', @Currentdate, @UserId,@CompanyId)
		        ,(NEWID(), 'Received','Received', '#00EAD3', @Currentdate, @UserId,@CompanyId)
            )
            AS Source ([Id], [StatusName],[InvoiceStatusName], [StatusColor], [CreatedDateTime], [CreatedByUserId],[CompanyId])
            ON Target.[StatusName] = Source.[StatusName]  AND Target.CompanyId=Source.CompanyId
            WHEN MATCHED THEN 
	...
	VALUES('ShareInvoiceToContracterEmailTemplate','<!doctype html>
<html lang="en">
                     ...
                     <tr>
                        <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                           ...
                           <h2 class="o_heading o_text-dark o_mb-xxs"
                              ...
                              Invoice Acceptance for ##InvoiceNo##
</h2>
                        </td>
                     </tr>
                  </tbody>
                  ...
                  <tbody>
                     <tr>
                        <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                           ...
                           <p style="margin-top: 0px;margin-bottom: 0px;">Hello, <br>Please Verify the invoice for your next action.<br>
Thank you.</p>
                           </p>
                        </td>
                     </tr>
...
</html>','Invoice Acceptance of ##InvoiceNo##',N'A9B7F5AD-FCE2-4068-AE6A-DCA0E3AE23F1')
	,('InvoiceAcceptanceByContracterEmailTemplate','<!doctype html>
<html lang="en">
                  ...
                  <tbody>
                     <tr>
                        <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                           ...
                           <h2 class="o_heading o_text-dark o_mb-xxs"
                              style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">
                              Invoice Accepted for ##InvoiceNo##
</h2>
                        </td>
                     </tr>
                  </tbody>
...
</html>','Invoice Accepted for ##InvoiceNo##',N'1A872528-DA92-4B7F-9BF4-A147E1BE671F')
	,('InvoiceRejectanceByContracterEmailTemplate','<!doctype html>
<html lang="en">
                  ...
                  <tbody>
                     <tr>
                        <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                           ...
                           <h2 class="o_heading o_text-dark o_mb-xxs"
                              style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">
                              Invoice Rejected for ##InvoiceNo##
</h2>
                        </td>
                     </tr>
                  </tbody>
...
</html>','Invoice Rejected for ##InvoiceNo##',N'E5293ECB-C329-4CED-894A-DAB8E1904141')
	,('InvoiceAcceptanceBySgtraderEmailTemplate','<!doctype html>
<html lang="en">
                  ...
                  <tbody>
                     <tr>
                        <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                           ...
                           <h2 class="o_heading o_text-dark o_mb-xxs"
                              style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">
                              Invoice Generated for ##InvoiceNo##
</h2>
                        </td>
                     </tr>
                  </tbody>
...
</html>','Invoice Generated for ##InvoiceNo##',N'42C3919B-DBC2-4B2F-87BC-F58E984C6D5F')
	,('InvoiceRejectanceBySgtraderEmailTemplate','<!doctype html>
<html lang="en">
...
Thank you.</p>
...
</html>','Invoice Rejected for ##InvoiceNo##',N'5C9D9118-AF99-485E-996A-8836A1325FA0')
 MERGE INTO [dbo].[EmailTemplates] AS Target 
	...
	USING ( VALUES
	        --ShareInvoiceToContracterEmailTemplate
           (NEWID(), N'##InvoiceNo##', N'A9B7F5AD-FCE2-4068-AE6A-DCA0E3AE23F1','This is invoice number', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'A9B7F5AD-FCE2-4068-AE6A-DCA0E3AE23F1','This is the invoice page link', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'A9B7F5AD-FCE2-4068-AE6A-DCA0E3AE23F1','This is the company logo', @CompanyId, GETDATE(), @UserId, NULL)
	        --InvoiceAcceptanceByContracterEmailTemplate
           ,(NEWID(), N'##InvoiceNo##', N'1A872528-DA92-4B7F-9BF4-A147E1BE671F','This is invoice number', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'1A872528-DA92-4B7F-9BF4-A147E1BE671F','This is the invoice page link', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'1A872528-DA92-4B7F-9BF4-A147E1BE671F','This is the company logo', @CompanyId, GETDATE(), @UserId, NULL)
	        --InvoiceRejectanceByContracterEmailTemplate
           ,(NEWID(), N'##InvoiceNo##', N'E5293ECB-C329-4CED-894A-DAB8E1904141','This is invoice number', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'E5293ECB-C329-4CED-894A-DAB8E1904141','This is the invoice page link', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'E5293ECB-C329-4CED-894A-DAB8E1904141','This is the company logoy', @CompanyId, GETDATE(), @UserId, NULL)
	        --InvoiceAcceptanceBySgtraderEmailTemplate
           ,(NEWID(), N'##InvoiceNo##', N'42C3919B-DBC2-4B2F-87BC-F58E984C6D5F','This is invoice number', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'42C3919B-DBC2-4B2F-87BC-F58E984C6D5F','This is the invoice page link', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'42C3919B-DBC2-4B2F-87BC-F58E984C6D5F','This is the company logo', @CompanyId, GETDATE(), @UserId, NULL)
	        --InvoiceRejectanceBySgtraderEmailTemplate
           ,(NEWID(), N'##InvoiceNo##', N'5C9D9118-AF99-485E-996A-8836A1325FA0','This is invoice number', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'5C9D9118-AF99-485E-996A-8836A1325FA0','This is the invoice page link', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'5C9D9118-AF99-485E-996A-8836A1325FA0','This is the company logo', @CompanyId, GETDATE(), @UserId, NULL)
		   )
