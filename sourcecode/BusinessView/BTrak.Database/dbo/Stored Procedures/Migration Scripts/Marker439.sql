CREATE PROCEDURE [dbo].[Marker439]
(
...
DECLARE @Template TABLE
	...
	VALUES('ProgramLevelAccessTemplate','<!doctype html>
<html lang="en">
                  ...
                  <tbody>
                     <tr>
                        <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                           ...
                           <p style="margin-top: 0px;margin-bottom: 0px;">Hello, <br>##BodyDescription##<br><br/>
Thank you.</p>
                           </p>
                        </td>
                     </tr>
...
</html>','##SubjectDescription##',N'869D7459-76EF-41E6-9581-0C059A537212'),
('ValidatorPerformAuditAcceptorRejectTemplate','<!doctype html>
<html lang="en">
                  ...
                  <tbody>
                     <tr>
                        <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                           ...
                           <p style="margin-top: 0px;margin-bottom: 0px;">Hello, <br>##BodyDescription##<br>Comments:##Comments##<br/>
Thank you.</p>
                           </p>
                        </td>
                     </tr>
...
</html>','##SubjectDescription##',N'D7560141-01B5-4151-BF10-D22CC125E774')
 MERGE INTO [dbo].[EmailTemplates] AS Target 
	...
	USING ( VALUES
	       --Program Level Access Template
           (NEWID(), N'##ProgramName##', N'869D7459-76EF-41E6-9581-0C059A537212','Name of the selected program', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##LevelName##', N'869D7459-76EF-41E6-9581-0C059A537212','Name of user level', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##siteUrl##', N'869D7459-76EF-41E6-9581-0C059A537212','site address', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##CompanyLogo##', N'869D7459-76EF-41E6-9581-0C059A537212','User company logo', @CompanyId, GETDATE(), @UserId, NULL)
           --Validator PerformAudit Accept or Reject Template
           ,(NEWID(), N'##ProgramName##', N'D7560141-01B5-4151-BF10-D22CC125E774','Name of the selected program', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ValidatorName##', N'D7560141-01B5-4151-BF10-D22CC125E774','Validator Name', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##siteUrl##', N'869D7459-76EF-41E6-9581-0C059A537212','site address', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##Comments##', N'869D7459-76EF-41E6-9581-0C059A537212','accept or reject comment by user', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##CompanyLogo##', N'869D7459-76EF-41E6-9581-0C059A537212','User company logo', @CompanyId, GETDATE(), @UserId, NULL))
