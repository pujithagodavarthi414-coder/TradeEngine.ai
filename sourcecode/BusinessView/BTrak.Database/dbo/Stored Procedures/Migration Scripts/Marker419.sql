CREATE PROCEDURE [dbo].[Marker419]
(
...
BEGIN
   ...
   Update [dbo].[EmailTemplates] Set [EmailTemplate] = '<!DOCTYPE html
...
<p style="color:#262626; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif">KYC details are verified and your account is created successfully. Please find below your login credentials.</p>
...
</html>' WHERE EmailTemplateName = 'KYCSubmissionTemplate'
...
</html>' WHERE TemplateName = 'InterviewStatusChangeEmail'
                        ...
                        <tr>
                           <td>
                              ...
                              <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
                                 <tbody>
                                    <tr>
                                       <td class="o_bg-white" style="font-size: 48px;line-height: 2px;height: 2px;background-color: #ffffff;">&nbsp; </td>
                                    </tr>
                                 </tbody>
                              </table>
                              <!--[if mso]>
...
</html>' WHERE TemplateName ='HiredDocumentsEmailTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
	<html lang="en">
	  <head>
		<meta charset="utf-8">
	...
	</html>' WHERE TemplateName ='UserRegistrationNotificationTemplate'
    UPDATE HtmlTemplates SET HtmlTemplate = '<!doctype html>
	<html lang="en">
	  <head>
		<meta charset="utf-8">
			...
			<tr>
			  <td class="o_bg-light o_px-xs" align="center" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;">
				...
				<table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
				  <tbody>
					<tr>
					  <td class="o_bg-white" style="font-size: 48px;line-height: 10px;height: 10px;background-color: #ffffff;">&nbsp; </td>
					</tr>
				  </tbody>
				</table>
				<!--[if mso]></td></tr></table><![endif]-->
	...
	</html>' WHERE TemplateName = 'CompanyRegistrationTemplate'
	UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
            ...
            <tbody>
              <tr>
                <td class="o_re o_bg-white o_px o_pb-md o_br-t" align="center"
                  style="font-size: 0;vertical-align: top;background-color: #ecf9fb;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-bottom: 15px;">
                  <!--[if mso]><table cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td width="200" align="left" valign="top" style="padding:0px 8px;"><![endif]-->
                  <div class="o_col o_col-2"
                    ...
                    src="https://bviewstorage.blob.core.windows.net/localsiteuploads/Time_Champ_logo_2_3_copy-292056aa-fc5f-468c-b5a5-df6084fd68ef.png"
                            width="150" height="36"
                            style="max-width: 150px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a>
                      </p>
                    </div>
                  </div>
                </td>
            ...
            <tbody>
              <tr>
                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                  style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ecf9fb;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 10px;padding-bottom: 10px;">
                  <p style="font-size: 20px;margin-top: 0px;margin-bottom: 10px;color: #149a9a;font-family: Palatino Linotype;">Hi ##userName##, here is the summary report of your associates for ##CurrentDate##.</p>
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <td class="o_bg-light o_px-xs" align="center"
          ...
          <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
            ...
            <tbody>
              <tr>
                <td class="o_bg-white"
                  style="font-size: 20px;line-height: 40px;height: 20px;background-color: #dbe5ea;">&nbsp;
                </td>
              </tr>
            </tbody>
          </table>
...
</html>' WHERE TemplateName ='ManagerDailyAssociateSummaryEmailTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>  
<html lang="en">
   <head>
      <meta charset="utf-8">
...
</html>' WHERE TemplateName ='OfferMailTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
	<html lang="en">
	  <head>
		<meta charset="utf-8">
	...
	</html>' WHERE TemplateName ='RemoteSiteCompanyRegistrationTemplate'
	UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>  
<html lang="en">
   <head>
      <meta charset="utf-8">
...
</html>' WHERE TemplateName ='JobOpeningEmailTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
</html>' WHERE TemplateName ='InterviewScheduleCancelledTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
</html>' WHERE TemplateName ='CandidateAssignedToManagerEmail'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
</html>' WHERE TemplateName ='CandidateScheduleRemainderTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
<html lang="en">
...
</html>' WHERE TemplateName ='InterviewScheduleApprovalTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
	<html lang="en">
	  <head>
		<meta charset="utf-8">
	...
	</html>' WHERE TemplateName ='ResetPasswordTemplate'
    UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
</html>' WHERE TemplateName ='CandidateCreationEmailTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<body class="o_body o_bg-light"
          ...
          <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
            ...
            <tbody>
              <tr>
                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                  style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ecf9fb;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 10px;padding-bottom: 10px;">
                  <p style="font-size: 20px;margin-top: 0px;margin-bottom: 10px;color: #149a9a;font-family: Palatino Linotype;">Here is your teams summary report</p>
                   <p style="font-size: 19px;margin-top: 5px;margin-bottom: 10px;color: #149a9a;font-family: Palatino Linotype;">##Date##</p>
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <td class="o_bg-light o_px-xs" align="center"
          ...
          <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
            ...
            <tbody>
              <tr>
                <td class="o_bg-white"
                  style="font-size: 20px;line-height: 40px;height: 20px;background-color: #dbe5ea;">&nbsp; </td>
              </tr>
            </tbody>
          </table>
        </td>
  ...
  <div style="text-align: center">
  ##TrackerWorkedOverTime##
  </div>
  <div style="text-align: center">
  ##TrackerWorkedLessTime##
  </div>
   <div style="text-align: center">
   ##UsersLeaveYesterday##
   </div>
   ...
   <div style="text-align: center">
   ##UsersWorkAnniversaryToday##
   </div>
   <div style="text-align: center">
   ##UsersMarriageAnniversaryToday##
   </div>
</body>
</html>' WHERE TemplateName ='CompanyLevelProductivityEmailTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>   
             <html lang="en">
                <head>
                   <meta charset="utf-8">
             ...
             </html>' WHERE TemplateName ='ClientKYCAlertMail'
             UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
<html lang="en">
...
</html>' WHERE TemplateName ='InterviewScheduleConfirmedTemplate'
UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>
	<html lang="en">
	  <head>
		<meta charset="utf-8">
	...
	</html>' WHERE TemplateName ='RegistrationVerificationEmailTemplate'
    UPDATE HtmlTemplates SET HtmlTemplate ='<!doctype html>   
            <html lang="en">
               <head>
                  <meta charset="utf-8">
            ...
            </html>' WHERE TemplateName ='ClientRegistrationMail'
END