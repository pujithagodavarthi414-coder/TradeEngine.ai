CREATE PROCEDURE [dbo].[Marker384]
(
...
DECLARE @Template TABLE
	...
	VALUES('SwitchBlBuyerContractAcceptanceTemplate','<!doctype html>
<html lang="en">
                     ...
                     <tr>
                        <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                           ...
                           <h2 class="o_heading o_text-dark o_mb-xxs"
                              ...
                              Buyer contract acceptance for ##ContractId##
</h2>
                        </td>
                     </tr>
                  </tbody>
                  ...
                  <tbody>
                     <tr>
                        <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                           ...
                           <p style="margin-top: 0px;margin-bottom: 0px;">Hello, <br>Buyer selected ##ActionType## action,<br>##SgTraderAction##<br>Please find the buyer contract for your next action.<br>
Thank you.</p>
                           </p>
                        </td>
                     </tr>
...
</html>','Buyer contract acceptance by SgTrader for ##ContractId## for ##Commodity## - ##ContractQuantity## MT and for ##VesselId## - ##VesselQuantity## MT',N'99FD3CD9-A8DB-4432-A04D-F56080100D51'),
('SwitchBlBuyerContractRejectionTemplate','<!doctype html>
<html lang="en">
                  ...
                  <tbody>
                     <tr>
                        <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                           ...
                           <h2 class="o_heading o_text-dark o_mb-xxs"
                              style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">
                              Buyer contract rejection for ##ContractId##
</h2>
                        </td>
                     </tr>
                  </tbody>
...
Thank you.</p>
   ...
   <table class="o_block-lg" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
...
</html>','Buyer contract rejection by SgTrader for ##ContractId## for ##Commodity## - ##ContractQuantity## MT and for ##VesselId## - ##VesselQuantity## MT',N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08')
	...
	USING ( VALUES
	        --Buyer switchbl contract acceptance by SgTrader
           (NEWID(), N'##ContractQuantity##', N'99FD3CD9-A8DB-4432-A04D-F56080100D51','This is contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ContractId##', N'99FD3CD9-A8DB-4432-A04D-F56080100D51','This is the contract number', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##Commodity##',N'99FD3CD9-A8DB-4432-A04D-F56080100D51','This is the company logo used to send email', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##VesselId##',N'99FD3CD9-A8DB-4432-A04D-F56080100D51','This is your vesselId', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##VesselQuantity##',N'99FD3CD9-A8DB-4432-A04D-F56080100D51','This is the vessel quantity', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ActionType##',N'99FD3CD9-A8DB-4432-A04D-F56080100D5199FD3CD9-A8DB-4432-A04D-F56080100D51','This is the buyer action type', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##SgTraderAction##',N'99FD3CD9-A8DB-4432-A04D-F56080100D51','This is the action performed by SgTrader as per buyer requirements', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##PriceAmount##',N'99FD3CD9-A8DB-4432-A04D-F56080100D51','This is the register site address used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'99FD3CD9-A8DB-4432-A04D-F56080100D51','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'99FD3CD9-A8DB-4432-A04D-F56080100D51','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL),
           --Buyer switchbl contract rejection by SgTrader
           (NEWID(), N'##ContractQuantity##', N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ContractId##', N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is the contract number', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##Commodity##',N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is the company logo used to send email', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##VesselId##',N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is your vesselId', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##VesselQuantity##',N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is the vessel quantity', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ActionType##',N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is the buyer action type', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##SgTraderAction##',N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is the action performed by SgTrader as per buyer requirements', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##PriceAmount##',N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is the register site address used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'0C5BC37D-4F7B-4157-B34F-BC642EA7DC08','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL))
...
</html>' WHERE EmailTemplateName = 'SellerSignatureRejectEmailTemplate' AND CompanyId = @CompanyId
...
</html>' WHERE EmailTemplateName = 'BuyerSignatureRejectEmailTemplate' AND CompanyId = @CompanyId
