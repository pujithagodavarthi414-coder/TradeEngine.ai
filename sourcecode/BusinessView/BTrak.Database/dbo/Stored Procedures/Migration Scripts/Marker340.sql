CREATE PROCEDURE [dbo].[Marker340]
(
...
BEGIN
    ...
    USING ( VALUES 
     (NEWID(),'This app can be used to TVA', N'TVA', CAST(N'2021-10-07 19:27:24.523' AS DateTime),@UserId,@CompanyId,NULL,NULL,NULL)
    )
	...
	MERGE INTO [dbo].[WidgetModuleConfiguration] AS Target 
		USING (VALUES 
	(NEWID(),(SELECT Id FROM Widget WHERE WidgetName = 'TVA' AND CompanyId = @CompanyId),'EF94A114-B7A0-49B8-B4F7-D99F1E121C4F',@UserId,@Currentdate)
	 )
	...
	MERGE INTO [dbo].[WidgetRoleConfiguration] AS Target 
		USING (VALUES 
	(NEWID(),(SELECT Id FROM Widget WHERE CompanyId = @CompanyId AND WidgetName = 'TVA'),@RoleId,GETDATE(),@UserId)
	 )
    ...
    USING ( VALUES
		(NEWID(), @RoleId, N'EF549308-1F98-4DE0-AE91-39E879A66888', CAST(N'2021-10-08 17:39:32.367' AS DateTime),@UserId)
    )
	...
	USING ( VALUES 
     (NEWID(),(SELECT TOP 1 Id FROM Workspace WHERE WorkspaceName  = 'Customized_advancedinvoices' AND CompanyId = @CompanyId),0,0, 27,16, 5,  5, 4,  'TVA',NULL,0,NULL,@UserId,GETDATE() ,@CompanyId)
