CREATE PROCEDURE [dbo].[Marker280]
(
...
SET NOCOUNT ON
 ...
 MERGE INTO [dbo].[CompanyModule] AS Target 
    USING ( VALUES 
	(NEWID(),'5A31FC4E-BA93-4BED-B914-E44A5176C673',@CompanyId,0,0,@UserId,GetDate())
        )AS Source  ([Id], ModuleId,CompanyId, IsActive,IsEnabled, [CreatedByUserId], [CreatedDateTime])
        ...
        INSERT ([Id], ModuleId,CompanyId, IsActive,IsEnabled, [CreatedByUserId], [CreatedDateTime]) VALUES
        ([Id], ModuleId,CompanyId, IsActive,IsEnabled, [CreatedByUserId], [CreatedDateTime]);     
