CREATE PROCEDURE [dbo].[Marker288]
(
...
('ActivityTrackerTrackingEmailTemplate','<!DOCTYPE html><html><head> <title>Template</title></head><body> Dear ##EmployeeName##,
<br/> This is to inform you that your system is getting tracked from ##TrackDateTime## through Snovasys business suite activity watcher.
<br/> Note: We are not tracking the information in your break period.
<br/> Best Regards,
<br/> ##footerName##</body></html>',@CompanyId)
,
('AuditReportMailTemplate','<!DOCTYPE html
    PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
                  ...
                  <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tr>
                      <td align="left" style="padding:50px 50px 50px 50px">
                        ...
                        <p
                          style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">
                         This is to inform that <b>##InvitedByName##</b> has invited you to submit a performance review against <b>##ofUserName##</b>.                       
                          <br /> 
                          <br />
                          Best Regards, <br />
                          ##CompanyName## Team
...
,
('UserStoryAssignedEmailTemplate','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      <!--[if !mso]><!-->
...
,
('UserStoryUpdateEmailTemplate','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      <!--[if !mso]><!-->
...
('VisualizationTemplate','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
		    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		    <!--[if !mso]><!-->
		            ...
		            <tr>
		                <td width="100%">
		                    <div class="webkit" style="max-width:800px;Margin:0 auto;">
		                        <table class="outer" align="center" cellpadding="0" cellspacing="0" border="0" style="border-spacing:0;Margin:0 auto;width:100%;max-width:900px;">
		                            <tr>
		                                <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">
		                                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
		                                        <tr>
		                                    ...
		                                    <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
		                                        <tr>
		                                            <td align="left" style="padding:50px 50px 50px 50px">
		                                                <p style="color:#262626; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif"><h2>Scheduled Charts:</h2></p>
																##FileURLS##
		                                                    <br />
		                                                    <br />
		                                                    <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">
