CREATE PROCEDURE [dbo].[Marker395]
(
...
BEGIN
	...
	VALUES(
    'DocumentUploadRequest','<!doctype html>
<html lang="en">
              ...
              <tbody>
                ...
                <tr>
                  <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                    ...
                    <h2 class="o_heading o_text-dark o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">Please Submit ##StepName## Documents</h2>
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                <tr>
                  <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                    ...
                    <p style="margin-top: 0px;margin-bottom: 0px;">We are pleased to inform that SG trader is waiting for ##StepName## documents. Please upload those documents. Ignore if it''s already done.</p>
                    </p>
                  </td>
                </tr>
              </tbody>
          ...
          <td class="o_bg-light o_px-xs" align="center" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;">
            ...
            <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
              <tbody>
                <tr>
                  <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                    <p style="margin-top: 0px;margin-bottom: 0px;">Please click the following link on your browser to upload documents</p>
                  </td>
                </tr>
              </tbody>
            </table>
                ...
                <tr>
                  <td class="o_bg-white" style="font-size: 24px;line-height: 24px;height: 24px;background-color: #ffffff;">&nbsp; </td>
                           ...
                           <h2 class="o_heading o_text-dark o_mb-xxs"
                              ...
                              SwitchBL buyer contract rejection by SgTrader for ##ContractId##
</h2>
                        </td>
                     </tr>
                  </tbody>
...
','Upload Request',N'DDE724DA-92D3-4EA4-8789-17249527B7B2') 
	    ...
	    USING ( VALUES
	    	   (NEWID(), N'##StepName##',N'DDE724DA-92D3-4EA4-8789-17249527B7B2','This is the used to specify email related to specify particular step', @CompanyId, GETDATE(), @UserId, NULL)
...
</html>' WHERE  EmailTemplateName = 'PurchaseDocumentRemind' AND CompanyId = @CompanyId
...
</html>' WHERE EmailTemplateName = 'PurchaseRejectedEmail' AND CompanyId = @CompanyId
