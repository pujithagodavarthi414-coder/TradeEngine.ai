CREATE PROCEDURE [dbo].[Marker402]
(
...
MERGE INTO [dbo].[CompanySettings] AS Target
	USING ( VALUES
			 (NEWID(), @CompanyId, N'ClickSendAccountEmail', N'alakananda@snovasys.com',N'click send account email', GETDATE(), @UserId),
			 (NEWID(), @CompanyId, N'ClickSendAccountPassword', N'Snovasys@123',N'click send account password', GETDATE(), @UserId)
	)
...
DECLARE @Template TABLE
	...
	VALUES('SwitchBlPdfGenerationTemplate','<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
','SwitchBl pdf generation,view pdf for furthur details',N'810CB548-95B0-441F-A7D4-4436B51E094E')
	...
	USING ( VALUES
           ...
           (NEWID(), N'##Quantity##', N'810CB548-95B0-441F-A7D4-4436B51E094E','This is contract name', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ShipperAddress##', N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the shipper address', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##COMMODITY##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the company logo used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##NotifyAddress##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the notify address', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##OnBoardthetanker##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the onBoardthetanker', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##Flag##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the flag', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##Master##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the master', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##Loadedattheportof##',N'810CB548-95B0-441F-A7D4-4436B51E094EE','This is the loadedattheportof', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##Tobedeliverdtotheportof##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the tobedeliverdtotheportof', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##VoyageNumber##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the voyageNumber', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##VesselBlNumbers##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the vesselBlNumbers', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SLOP S##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the slops', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##TotalBlNumbers##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the totalBlNumbers', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SwitchBlInvoiceDate##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the switchBlInvoiceDate', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SignedDay##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the signedDay', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SignedMonth##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the signedMonth', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SignedYear##',N'810CB548-95B0-441F-A7D4-4436B51E094E','This is the signedYear', @CompanyId, GETDATE(), @UserId, NULL))
