CREATE PROCEDURE [dbo].[Marker391]
(
...
BEGIN
  ...
  ('SGTraderContractCancelEmailTemplate','<!doctype html>
<html lang="en">
...
Thank you.</p>
   ...
   <table class="o_block-lg" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
...
</html>','SGTrader contract cancel email template ##ContractId## for ##Commodity## - ##Quantity## ##MeasurementUnit##',N'995BCB59-A494-4573-B219-C035DC855AF6')
	...
	USING ( VALUES
           ...
           --SGTrader Cancel Contract
           (NEWID(), N'##Quantity##', N'995BCB59-A494-4573-B219-C035DC855AF6','This is contract name', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ContractId##', N'995BCB59-A494-4573-B219-C035DC855AF6','This is the url to login to the system for contract view', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##Commodity##',N'995BCB59-A494-4573-B219-C035DC855AF6','This is the company logo used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##PriceAmount##',N'995BCB59-A494-4573-B219-C035DC855AF6','This is the register site address used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##siteUrl##',N'995BCB59-A494-4573-B219-C035DC855AF6','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'995BCB59-A494-4573-B219-C035DC855AF6','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##Comments##',N'995BCB59-A494-4573-B219-C035DC855AF6','This is the comments entered while contract cancellation', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##MeasurementUnit##',N'995BCB59-A494-4573-B219-C035DC855AF6','This is the measurement unit for contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
