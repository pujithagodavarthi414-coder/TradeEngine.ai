CREATE PROCEDURE [dbo].[Marker388]
(
...
DECLARE @Template TABLE
	...
	VALUES('SwitchBlContractAcceptOrRejectMailToBuyerTemplate','<!doctype html>
<html lang="en">
...
Thank you.</p>
   ...
   <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
...
</html>','SwitchBl contract accept/reject by buyer','6A2FC6F5-FBD0-41F7-9B6C-1B0EBBD86574')
	...
	USING ( VALUES
	        --Switchbl contract acceptance/rejection by buyer
           (NEWID(), N'##Quantity##', N'6A2FC6F5-FBD0-41F7-9B6C-1B0EBBD86574','This is contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ContractId##', N'6A2FC6F5-FBD0-41F7-9B6C-1B0EBBD86574','This is the contract number', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##Commodity##',N'6A2FC6F5-FBD0-41F7-9B6C-1B0EBBD86574','This is the company logo used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##PriceAmount##',N'6A2FC6F5-FBD0-41F7-9B6C-1B0EBBD86574','This is the register site address used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##siteUrl##',N'6A2FC6F5-FBD0-41F7-9B6C-1B0EBBD86574','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'6A2FC6F5-FBD0-41F7-9B6C-1B0EBBD86574','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL))
