...
DELETE FROM CustomAppColumns WHERE CompanyId = @CompanyId
...
UPDATE CustomWidgets SET CustomWidgetName = 'Highest bugs goals list' 
WHERE CustomWidgetName = 'More bugs goals list' AND CompanyId = @CompanyId

UPDATE WorkspaceDashboards SET [Name] ='Highest bugs goals list'
            WHERE [Name] = 'More bugs goals list' AND CompanyId = @CompanyId
...
WHERE [Name] = 'Employee lunch out Vs break < 30 mints'  AND CompanyId = @CompanyId

UPDATE CustomWidgets SET CustomWidgetName = 'Highest replanned goals'
WHERE CustomWidgetName = 'More replanned goals' AND CompanyId = @CompanyId

UPDATE WorkspaceDashboards SET [Name] = 'Highest replanned goals'
WHERE [Name] = 'More replanned goals'  AND CompanyId = @CompanyId
...
,(NEWID(),'Highest bugs goals list', NULL, 'SELECT * FROM(SELECT G.Id,G.GoalName [Goal name],COUNT(US.Id) [Work items count] ,					(SELECT COUNT(1) FROM UserStory US INNER JOIN Goal G1 ON US.GoalId = G1.Id AND G1.InActiveDateTime IS NULL AND US.InActiveDateTime IS NULL AND US.ParkedDateTime IS NULL AND G1.ParkedDateTime IS NULL
      ...
      FROM UserStory US INNER JOIN Project P ON P.Id = US.ProjectId AND P.InActiveDateTime IS NULL AND (''@ProjectId'' = '''' OR P.Id = ''@ProjectId'')
						...
						WHERE US.ParkedDateTime IS NULL AND G.ParkedDateTime IS NULL 
                             ...
                             AND ((''@IsReportingOnly'' = 1 AND US.OwnerUserId IN (SELECT ChildId FROM [dbo].[Ufn_GetEmployeeReportedMembers](''@OperationsPerformedBy'',''@CompanyId'') WHERE ChildId <>  ''@OperationsPerformedBy''))
	                               OR (''@IsMyself''= 1 AND   US.OwnerUserId = ''@OperationsPerformedBy'')
	                               OR (''@IsAll'' = 1))',(SELECT Id FROM CustomAppSubQueryType WHERE SubQueryType = N'Userstories'),@CompanyId,@UserId,GETDATE(),NULL)
...
,(NEWID(),(SELECT Id FROM CustomWidgets where CustomWidgetName = 'Planned vs unplanned work percentage' AND CompanyId = @CompanyId),'Planned work','decimal','SELECT US.Id FROM UserStory US 
							  INNER JOIN Project P ON P.Id = US.ProjectId 
				...
				WHERE US.Id IN (SELECT UserStoryId FROM UserStorySpentTime UST WHERE  CAST(UST.DateFrom AS date) = CAST(DATEADD(DAY,-1,GETDATE()) AS date)
...
,(NEWID(),(SELECT Id FROM CustomWidgets where CustomWidgetName =  'Planned vs unplanned work percentage' AND CompanyId = @CompanyId),'Un planned work','decimal','SELECT US.Id FROM UserStory US 
							  INNER JOIN Project P ON P.Id = US.ProjectId 
							  AND (''@ProjectId'' = '''' OR P.Id = ''@ProjectId'') AND P.CompanyId = (SELECT CompanyId FROM [User] WHERE Id = ''@OperationsPerformedBy'' AND InActiveDateTime IS NULL)
				              INNER JOIN UserProject UP ON UP.ProjectId = P.Id AND UP.InActiveDateTime IS NULL AND UP.UserId = ''@OperationsPerformedBy''
				LEFT JOIN Goal G ON G.Id = US.GoalId
...
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest bugs goals list' AND CompanyId = @CompanyId),'Work items count','int','SELECT US.Id  FROM UserStory US 
INNER JOIN Goal G ON G.Id = US.GoalId AND US.InActiveDateTime IS NULL
        AND G.InActiveDateTime IS NULL AND US.ParkedDateTime IS NULL AND G.ParkedDateTime IS NULL
WHERE G.Id = ''##Id##''
    AND ((''@IsReportingOnly'' = 1 AND US.OwnerUserId IN (SELECT ChildId FROM [dbo].[Ufn_GetEmployeeReportedMembers]
									   (''@OperationsPerformedBy'',''@CompanyId'')WHERE ChildId <>  ''@OperationsPerformedBy''))
									    OR (''@IsMyself''= 1 AND   US.OwnerUserId = ''@OperationsPerformedBy'' )
										OR (''@IsAll'' = 1))',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType ='Userstories' ),@CompanyId,@UserId,GETDATE(),NULL)
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest bugs goals list' AND CompanyId = @CompanyId),'Bugs count','int','SELECT US.Id FROM UserStory US INNER JOIN Goal G1 ON US.GoalId = G1.Id AND G1.InActiveDateTime IS NULL 
...
WHERE  (US.TestCaseId IS NULL OR TC.Id IS Not NULL)
			...
			AND ((''@IsReportingOnly'' = 1 AND US.OwnerUserId IN (SELECT ChildId FROM [dbo].[Ufn_GetEmployeeReportedMembers]
									   (''@OperationsPerformedBy'',''@CompanyId'')WHERE ChildId <>  ''@OperationsPerformedBy''))
									    OR (''@IsMyself''= 1 AND   US.OwnerUserId = ''@OperationsPerformedBy'' )
										OR (''@IsAll'' = 1))',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType ='Userstories' ),@CompanyId,@UserId,GETDATE(),NULL)
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest bugs goals list' AND CompanyId = @CompanyId),'Goal name','nvarchar','SELECT G.Id  FROM Goal G
WHERE G.Id = ''##Id##''',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType = 'Goal'),@CompanyId,@UserId,GETDATE(),NULL)
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest bugs goals list' AND CompanyId = @CompanyId),'Id','uniqueidentifier',null,null,@CompanyId,@UserId,GETDATE(),1)
-- ,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest replanned goals' AND  CompanyId = @CompanyId),'Goal name','nvarchar','SELECT Id,GoalName,GoalUniqueName FROM Goal WHERE Id = ''##Id##''',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType ='Goal' ),@CompanyId,@UserId,GETDATE(),NULL)
--,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest replanned goals' AND CompanyId = @CompanyId),'Replan count','int',NULL,(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType = ''),@CompanyId,@UserId,GETDATE(),NULL)
--,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest replanned goals' AND  CompanyId = @CompanyId),'Id','uniqueidentifier',null,null,@CompanyId,@UserId,GETDATE(),1)
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Today''s target'  AND CompanyId = @CompanyId),'Today target','int','SELECT US.Id FROM UserStory US INNER JOIN Goal G ON US.GoalId = G.Id AND G.InActiveDateTime IS NULL AND US.InActiveDateTime IS NULL 
	                           INNER JOIN GoalStatus GS ON GS.Id = G.GoalStatusId AND GS.InActiveDateTime IS NULL AND GS.IsActive = 1
							   INNER JOIN UserStoryStatus USS ON USS.Id = US.UserStoryStatusId AND USS.CompanyId = (SELECT CompanyId FROM [User] WHERE Id = ''@OperationsPerformedBy'' AND InActiveDateTime IS NULL)
							   INNER JOIN TaskStatus TS ON TS.Id = USS.TaskStatusId AND TS.Id = ''5C561B7F-80CB-4822-BE18-C65560C15F5B''
...
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Employee blocked work items/dependency analysis'  AND CompanyId = @CompanyId),'Work item','nvachar','SELECT Id,UserStoryName FROM UserStory WHERE Id = ''##Id##''',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType ='UserStory' ),@CompanyId,@UserId,GETDATE(),NULL)
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Employee blocked work items/dependency analysis' AND CompanyId = @CompanyId),'Owner name','nvachar','SELECT Id,UserStoryName FROM UserStory WHERE Id = ''##Id##''',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType ='UserStory' ),@CompanyId,@UserId,GETDATE(),NULL)
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Employee blocked work items/dependency analysis' AND CompanyId = @CompanyId),'Dependency user','nvachar','SELECT Id,UserStoryName FROM UserStory WHERE Id = ''##Id##''',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType ='UserStory' ),@CompanyId,@UserId,GETDATE(),NULL)
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Employee blocked work items/dependency analysis'  AND CompanyId = @CompanyId),'Id','uniqueidentifier',null,null,@CompanyId,@UserId,GETDATE(),1)
...
,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'All test suites' AND  CompanyId = @CompanyId),'Total bugs count','int','SELECT US.Id,US.UserStoryName
	 ...
	 GROUP BY US.Id,US.UserStoryName',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType = 'Userstories'),@CompanyId,@UserId,GETDATE(),NULL)
	 , (NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest replanned goals'  AND CompanyId = @CompanyId),'Id','uniqueidentifier',NULL,NULL,@CompanyId,@UserId,GETDATE(),1)
 ,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest replanned goals' AND CompanyId = @CompanyId),'Goal name','nvarchar','SELECT Id,GoalName FROM Goal WHERE Id = ''##Id##''',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType ='Goal' ),@CompanyId,@UserId,GETDATE(),NULL)
 ,(NEWID(),(SELECT Id FROM CustomWidgets WHERE CustomWidgetName = 'Highest replanned goals' AND CompanyId = @CompanyId),'Replan count','int','SELECT Id,GoalName FROM Goal WHERE Id = ''##Id##''',(SELECT Id FROM CustomAppSubQueryType WHERE  SubQueryType = 'GoalReplanHistory'),@CompanyId,@UserId,GETDATE(),NULL)
...
, (NEWID(),(SELECT Id FROM CustomWidgets where CompanyId = @CompanyId AND CustomWidgetName = 'Afternoon late trend graph'),'Date', 'date','SELECT TS.[Date],U.FirstName+'' ''+U.SurName [Employee name],DATEDIFF(MINUTE,LunchBreakStartTime,LunchBreakEndTime)[Late in mins]
...
HAVING DATEDIFF(MINUTE,LunchBreakStartTime,LunchBreakEndTime) > 70
	',(SELECT Id FROM CustomAppSubQueryType WHERE SubQueryType ='CustomSubQuery' ),@CompanyId,@UserId,GETDATE(),NULL)
,(NEWID(),(SELECT Id FROM CustomWidgets where CompanyId = @CompanyId AND CustomWidgetName = 'Afternoon late trend graph'),'Afternoon late count', 'int','SELECT TS.[Date],U.FirstName+'' ''+U.SurName [Employee name],DATEDIFF(MINUTE,LunchBreakStartTime,LunchBreakEndTime)[Late in mins]
 FROM TimeSheet TS INNER JOIN [User]U ON U.Id = TS.UserId AND U.InActiveDateTime IS NULL
WHERE TS.InActiveDateTime IS NULL AND (TS.[Date] <= CAST(GETDATE() AS date) AND TS.[Date] >= CAST(DATEADD(DAY,-30,GETDATE()) AS date))
AND U.CompanyId = (SELECT CompanyId FROM [User] WHERE Id = ''@OperationsPerformedBy'' AND InActiveDateTime IS NULL) 
AND TS.Date = CAST(''##Date##'' AS DATE)
...
,(NEWID(),(SELECT Id FROM CustomWidgets where CompanyId = @CompanyId AND CustomWidgetName = 'Company level productivity'),'Productivity', 'numeric','SELECT * FROM
	(SELECT ProjectName,ISNULL(SUM(PID.EstimatedTime),0)Productivity
	 ...
	 AND InActiveDateTime IS NULL))PID inner join UserStory US ON US.Id = PID.UserStoryId
											INNER JOIN Project P ON P.Id = US.ProjectId
											group by ProjectName)t',(SELECT Id FROM CustomAppSubQueryType WHERE SubQueryType ='CustomSubQuery' ),@CompanyId,@UserId,GETDATE(),NULL)
,(NEWID(),(SELECT Id FROM CustomWidgets where CompanyId = @CompanyId AND CustomWidgetName = 'Today''s leaves count'),'Today''s leaves count', 'int','SELECT LAP.Id from
...
,(NEWID(),(SELECT Id FROM CustomWidgets where CompanyId = @CompanyId AND CustomWidgetName = 'Leaves waiting for approval'),'Leaves waiting approval', 'int','SELECT LAP.Id from
			(SELECT DATEADD(DAY,NUMBER,LA.LeaveDateFrom) AS [Date],LA.Id 
			        FROM master..SPT_VALUES MSPT
				    JOIN LeaveApplication LA ON MSPT.NUMBER <= DATEDIFF(DAY,LA.LeaveDateFrom,LA.LeaveDateTo) AND [Type] = ''P'' AND LA.InActiveDateTime IS NULL
										    ) T
...
WHERE P.CompanyId = (SELECT CompanyId FROM [User] WHERE Id = ''@OperationsPerformedBy'' AND InActiveDateTime IS NULL)
      AND ((''@IsReportingOnly'' = 1 AND US.OwnerUserId IN (SELECT ChildId FROM [dbo].[Ufn_GetEmployeeReportedMembers]
									   (''@OperationsPerformedBy'',''@CompanyId'') WHERE ChildId <>  ''@OperationsPerformedBy''))
										...
										OR (''@IsAll'' = 1))
GROUP BY ProjectName,P.Id',@CompanyId,@UserId,GETDATE())
,(NEWID(),'Total bugs count','','SELECT COUNT(1) [Total Bugs Count] FROM UserStory US INNER JOIN Project P ON P.Id = US.ProjectId AND P.InActiveDateTime IS NULL 
								  AND (''@ProjectId'' = '''' OR P.Id = ''@ProjectId'')
				            INNER JOIN UserStoryType UST ON UST.Id = US.UserStoryTypeId AND UST.InActiveDateTime IS NULL AND UST.IsBug = 1	                              
							LEFT JOIN  Goal G ON G.Id = US.GoalId AND US.InActiveDateTime IS NULL AND US.ParkedDateTime IS NULL
                            LEFT JOIN GoalStatus GS ON GS.Id = G.GoalStatusId AND G.InActiveDateTime IS NULL AND G.ParkedDateTime IS NULL AND GS.IsActive = 1 
						  ...
						  AND P.CompanyId = (SELECT CompanyId FROM [User] WHERE Id = ''@OperationsPerformedBy'' 
						 AND InActiveDateTime IS NULL)',@CompanyId,@UserId,GETDATE())
,(NEWID(),'Leaves waiting for approval','','SELECT ISNULL(SUM(Total.Cnt),0) AS [Leaves waiting approval] FROM 
	...
	AND CAST(US.DeadLineDate AS date) < CAST(GETDATE() AS date)
	 AND ((''@IsReportingOnly'' = 1 AND G.GoalResponsibleUserId IN (SELECT ChildId FROM [dbo].[Ufn_GetEmployeeReportedMembers]
									   (''@OperationsPerformedBy'',''@CompanyId'')WHERE ChildId <>  ''@OperationsPerformedBy''))
									    OR (''@IsMyself''= 1 AND  G.GoalResponsibleUserId = ''@OperationsPerformedBy'' )
										OR (''@IsAll'' = 1))
	 GROUP BY GoalName,G.Id,U.FirstName,U.SurName)T', @CompanyId, @UserId, CAST(N'2019-12-14T05:34:05.387' AS DateTime))
,(NEWID(),'Goal wise spent time VS productive hrs list', '', 'SELECT T.Id,T.SprintId,T.[Goal name],CAST(CAST(T.[Estimated time] AS int)AS  varchar(100))+''h ''+IIF(CAST((ISNULL(T.[Estimated time],0)*60)%60 AS INT) = 0,'''',CAST(CAST((ISNULL(T.[Estimated time],0)*60)%60 AS INT) AS VARCHAR(100))+''m'') [Estimated time],
	CAST(CAST(T.[Spent time] AS int)AS  varchar(100))+''h ''+IIF(CAST((ISNULL(T.[Spent time],0)*60)%60 AS INT) = 0,'''',CAST(CAST((ISNULL(T.[Spent time],0)*60)%60 AS INT) AS VARCHAR(100))+''m'') [Spent time]
	 FROM (SELECT G.Id,S.Id SprintId,GoalName [Goal name],SprintName [Sprint name],SUM(US.EstimatedTime) [Estimated time],ISNULL(CAST(SUM(UST.SpentTimeInMin/60.0) AS decimal(10,2)),0)[Spent time] 
	                    FROM  UserStory US INNER JOIN Project P ON P.Id = US.ProjectId AND P.InActiveDateTime IS NULL AND (''@ProjectId'' = '''' OR P.Id = ''@ProjectId'') 
...
,(NEWID(),'Delayed work items', '', 'SELECT US.UserStoryName As [Work item],US.Id FROM UserStory US INNER JOIN Project P ON P.Id = US.ProjectId AND US.InActiveDateTime IS NULL AND US.ParkedDateTime IS NULL
				...
				WHERE ((US.GoalId IS NOT NULL AND GS.Id IS  NOT NULL AND CAST(DeadLineDate as date) < cast(GETDATE() as date)) OR (US.SprintId IS NOT NULL AND S.Id IS Not NULL AND CAST(S.SprintEndDate AS date) < CAST(GETDATE() AS date))) 
						AND ((''@IsReportingOnly'' = 1 AND US.OwnerUserId IN (SELECT ChildId FROM [dbo].[Ufn_GetEmployeeReportedMembers](''@OperationsPerformedBy'',''@CompanyId'') WHERE ChildId <>  ''@OperationsPerformedBy''))
	                         OR (''@IsMyself''= 1 AND   US.OwnerUserId = ''@OperationsPerformedBy'')
	                         OR (''@IsAll'' = 1))', @CompanyId, @UserId, CAST(N'2019-12-14T05:34:05.387' AS DateTime))
,(NEWID(),'Yesterday logging compliance','','SELECT LC.* FROM  [dbo].[Ufn_GetCompliance] (''@OperationsPerformedBy'',10,NULL)LC 
             INNER JOIN [User]U ON U.Id = LC.Id AND U.InActiveDateTime IS NULL
			 WHERE  ((''@IsReportingOnly'' = 1 AND U.Id IN (SELECT ChildId FROM [dbo].[Ufn_GetEmployeeReportedMembers](''@OperationsPerformedBy'',''@CompanyId'') WHERE ChildId <>  ''@OperationsPerformedBy''))
									    OR (''@IsMyself''= 1 AND U.Id  = ''@OperationsPerformedBy'' )
										OR (''@IsAll'' = 1))',@CompanyId,@UserId,GETDATE())
,(NEWID(),'Pipeline work', '', 'SELECT G.GoalName [Goal name ],S.SprintName [Sprint name] ,US.UserStoryName [Work item name], ISNULL(DeadLineDate,SprintEndDate) [Deadline date] ,US.Id,US.SprintId,US.GoalId
              FROM UserStory US  INNER JOIN Project P ON P.Id = US.ProjectId AND P.InActiveDateTime IS NULL 
...
'Employee blocked work items/dependency analysis',
...
'Planned work Vs unplanned work team wise',
...
'Today''s leaves count',
'Total bugs count',
'Highest bugs goals list',
'Highest replanned goals', 
'Yesterday logging compliance',
'Delayed work items'
,'Today''s work items ',
'Delayed goals',
'Goal work items VS bugs count','Items waiting for QA approval'
