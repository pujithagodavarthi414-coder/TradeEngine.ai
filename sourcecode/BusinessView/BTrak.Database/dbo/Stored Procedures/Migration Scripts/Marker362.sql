CREATE PROCEDURE [dbo].[Marker362]
(
...
(NEWID(),'ClientRegistrationMail','<!doctype html>   
<html lang="en">
   <head>
      <meta charset="utf-8">
...
MERGE INTO [dbo].[ClientType] AS Target 
	USING ( VALUES
	       (NEWID(), N'Supplier', @CompanyId, GETDATE(), @UserId, NULL,1),
		   (NEWID(), N'Buyer', @CompanyId, GETDATE(), @UserId, NULL,2),
		   (NEWID(), N'Other', @CompanyId, GETDATE(), @UserId, NULL,3)
	        ) 
...
MERGE INTO [dbo].[ClientTypeRoles] AS Target 
	USING ( VALUES
	       (NEWID(), @RoleId, (SELECT TOP 1 Id FROM ClientType WHERE ClientTypeName='Supplier' AND CompanyId=@CompanyId), @CompanyId, GETDATE(), @UserId, NULL),
		   (NEWID(), @RoleId, (SELECT TOP 1 Id FROM ClientType WHERE ClientTypeName='Buyer' AND CompanyId=@CompanyId), @CompanyId, GETDATE(), @UserId, NULL),
		   (NEWID(), @RoleId, (SELECT TOP 1 Id FROM ClientType WHERE ClientTypeName='Other' AND CompanyId=@CompanyId), @CompanyId, GETDATE(), @UserId, NULL)
	        ) 
