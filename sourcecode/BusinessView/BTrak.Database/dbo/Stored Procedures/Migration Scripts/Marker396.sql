CREATE PROCEDURE [dbo].[Marker396]
(
...
DECLARE @Template TABLE
	...
	VALUES('SwitchBlBuyerAcceptenceMailToSgTraderTemplate','<!doctype html>
<html lang="en">
...
</html>','SwitchBL contract is accepted by ##UserName##',N'5E0FE56C-AAC7-4B9B-AA81-D74CD6A873DE'),
('SwitchBlBuyerRejectionMailToSgTraderTemplate','<!doctype html>
<html lang="en">
...
</html>','SwitchBL contract is rejected by ##UserName##',N'803F8E5E-1262-4926-A488-F64037EEE00C'),
('SwitchBlContractMailToVesselOwnerTemplate','<!doctype html>
<html lang="en">
...
Thank you.</p>
   ...
   <table class="o_block-lg" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
...
</html>','SwitchBl vessel owner Accept/reject',N'9A68B156-4EFC-4704-82E6-6682AEE55F8A')
    ...
    ON Target.[EmailTemplateName] = Source.[EmailTemplateName] AND Target.[CompanyId] = Source.[CompanyId] AND Target.[ClientId] = Source.[ClientId]
    WHEN MATCHED THEN 
	...
	USING ( VALUES
           ...
           (NEWID(), N'##Quantity##', N'5E0FE56C-AAC7-4B9B-AA81-D74CD6A873DE','This is contract name', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ContractId##', N'5E0FE56C-AAC7-4B9B-AA81-D74CD6A873DE','This is the url to login to the system for contract view', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##Commodity##',N'5E0FE56C-AAC7-4B9B-AA81-D74CD6A873DE','This is the company logo used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##PriceAmount##',N'5E0FE56C-AAC7-4B9B-AA81-D74CD6A873DE','This is the register site address used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'5E0FE56C-AAC7-4B9B-AA81-D74CD6A873DE','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'5E0FE56C-AAC7-4B9B-AA81-D74CD6A873DE','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##MeasurementUnit##',N'5E0FE56C-AAC7-4B9B-AA81-D74CD6A873DE','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
           --SwitchBL buyer contract rejection by Buyer
           ,(NEWID(), N'##Quantity##', N'803F8E5E-1262-4926-A488-F64037EEE00C','This is contract name', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ContractId##', N'803F8E5E-1262-4926-A488-F64037EEE00C','This is the url to login to the system for contract view', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##Commodity##',N'803F8E5E-1262-4926-A488-F64037EEE00C','This is the company logo used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##PriceAmount##',N'803F8E5E-1262-4926-A488-F64037EEE00C','This is the register site address used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'803F8E5E-1262-4926-A488-F64037EEE00C','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'803F8E5E-1262-4926-A488-F64037EEE00C','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##MeasurementUnit##',N'803F8E5E-1262-4926-A488-F64037EEE00C','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
           --SwitchBL contract for vessel owner
           ,(NEWID(), N'##Quantity##', N'9A68B156-4EFC-4704-82E6-6682AEE55F8A','This is contract name', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##ContractId##', N'9A68B156-4EFC-4704-82E6-6682AEE55F8A','This is the url to login to the system for contract view', @CompanyId, GETDATE(), @UserId, NULL)
           ,(NEWID(), N'##Commodity##',N'9A68B156-4EFC-4704-82E6-6682AEE55F8A','This is the company logo used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##PriceAmount##',N'9A68B156-4EFC-4704-82E6-6682AEE55F8A','This is the register site address used to send email', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##SiteUrl##',N'9A68B156-4EFC-4704-82E6-6682AEE55F8A','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##CompanyLogo##',N'9A68B156-4EFC-4704-82E6-6682AEE55F8A','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##MeasurementUnit##',N'9A68B156-4EFC-4704-82E6-6682AEE55F8A','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL)
		   ,(NEWID(), N'##ContractSealedDateTime##',N'9A68B156-4EFC-4704-82E6-6682AEE55F8A','This is the contract quantity', @CompanyId, GETDATE(), @UserId, NULL))
	AS Source ([Id], [HtmlTagName],[HtmlTemplateId],[Description], [CompanyId], [CreatedDateTime], [CreatedByUserId], [InActiveDateTime]) 
	ON Target.[HtmlTagName] = Source.[HtmlTagName] AND Target.[HtmlTemplateId] = Source.[HtmlTemplateId] AND Target.[CompanyId] = Source.[CompanyId]
	WHEN MATCHED THEN 
...
</html>' WHERE EmailTemplateName = 'SwitchBlContractAcceptOrRejectMailToBuyerTemplate' AND CompanyId = @CompanyId

UPDATE [EmailTemplates] SET EmailSubject = 'SwitchBl contract accept/reject by buyer for ##ContractId## for ##Commodity## - ##Quantity## ##MeasurementUnit##' WHERE EmailTemplateName = 'SwitchBlContractAcceptOrRejectMailToBuyerTemplate' AND CompanyId = @CompanyId
    END
    GO