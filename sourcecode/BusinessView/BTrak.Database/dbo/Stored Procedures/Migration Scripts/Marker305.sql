CREATE PROCEDURE [dbo].[Marker305]
(
...
DECLARE @DefaultUserId UNIQUEIDENTIFIER = NULL
		...
		BEGIN
		MERGE INTO [dbo].[Trigger] AS Target 
        USING (VALUES
		 ('284FB120-B8C9-4186-8D46-54B6572DA20A','DocumentsUploadTrigger',CAST(N'2018-03-01T00:00:00.000' AS DateTime), @DefaultUserId)
        )
        AS Source ([Id],[TriggerName],[CreatedDateTime],[CreatedByUserId])
        ON Target.[TriggerName] = Source.[TriggerName]  
        WHEN MATCHED THEN 
        ...
        INSERT([Id],[TriggerName],[CreatedDateTime],[CreatedByUserId]) VALUES ([Id],[TriggerName],[CreatedDateTime],[CreatedByUserId]);
		END 

		UPDATE [dbo].[Trigger] SET Id = '284FB120-B8C9-4186-8D46-54B6572DA20A' WHERE [TriggerName] = 'DocumentsUploadTrigger'
...
MERGE INTO [dbo].[AutomatedWorkFlow] AS Target 
	...
	MERGE INTO [dbo].[WorkflowTrigger] AS Target 
        USING (VALUES
          (NEWID(),'284FB120-B8C9-4186-8D46-54B6572DA20A',(SELECT Id FROM [AutomatedWorkFlow] WHERE [WorkflowName] = 'Upload evidence' AND CompanyId = @CompanyId),'BFB5614F-34DE-45C2-AEDA-A2B387FA35C6',CAST(N'2018-03-01T00:00:00.000' AS DateTime), @DefaultUserId)
         )
