CREATE PROCEDURE [dbo].[USP_ProducePayrollComponentsForResignedEmployees]
(
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			UPDATE @BeforeMonths SET AllowedLeaves = ISNULL(AllowedLeaves,0) + ISNULL((SELECT TOP 1 CASE WHEN AllowedLeaves < PaidLeaves THEN 0 ELSE AllowedLeaves - PaidLeaves END 
		...
		BEGIN
			...
			UPDATE @LopMonths SET AllowedLeaves = ISNULL(AllowedLeaves,0) + ISNULL((SELECT TOP 1 CASE WHEN AllowedLeaves < PaidLeaves THEN 0 ELSE AllowedLeaves - PaidLeaves END 
...
--EXEC [USP_ProducePayrollComponentsForResignedEmployees] '127133F1-4427-4149-9DD6-B02E0E036971',NULL,NULL,'2020-03-01','2020-03-31'
--EXEC [USP_ProducePayrollComponentsForResignedEmployees] '127133F1-4427-4149-9DD6-B02E0E036971',NULL,NULL,'2020-05-01','2020-05-31'
--EXEC [USP_ProducePayrollComponentsForResignedEmployees] '9AEA475A-D9DC-427E-AC19-75BA324A8DF1',NULL,NULL,'2020-06-01','2020-06-30'
--EXEC [USP_ProducePayrollComponentsForResignedEmployees] '2C037AEE-4397-4F45-A261-A794A802B2D1',NULL,NULL,'2020-06-01','2020-06-30'