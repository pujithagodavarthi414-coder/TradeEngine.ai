...
-- Purpose      To Upsert PayRoll Files
-- Copyright © 2018,Snovasys Software Solutions India Pvt. Ltd., All Rights Reserved
---------------------------------------------------------------------------------------
--EXEC [dbo].[USP_UpsertPayRollFiles] 
...
--<FilePath>https://bviewstorage.blob.core.windows.net/4afeb444-e826-4f95-ac41-2175e36a0c16/PayRoll/0b2921a9-e930-4013-9047-670b5352f308/image_(6)-6942b197-443a-47c8-9e2d-d251f964ebc5.png</FilePath>
...
--<FilePath>https://bviewstorage.blob.core.windows.net/4afeb444-e826-4f95-ac41-2175e36a0c16/PayRoll/0b2921a9-e930-4013-9047-670b5352f308/image-2890dd63-a926-44ef-8e5a-0b4b5de2e6ae.png</FilePath>
--<FileExtension>.png</FileExtension>
--<IsArchived>false</IsArchived>
--</FileModel>
--</ListItems>
...
CREATE PROCEDURE [dbo].[USP_UpsertPayRollFiles]
(
   @FilesXML XML = NULL,
        ...
        BEGIN
            ...
            BEGIN
				...
				BEGIN	
					...
					DECLARE @FolderName NVARCHAR(50) = CASE WHEN @ReferenceTypeName = 'TaxAllowanceProofs' THEN (SELECT E.EmployeeNumber FROM Employee E JOIN EmployeeTaxAllowances ETA ON ETA.Id = @ReferenceId AND ETA.EmployeeId = E.Id)
													   END
					DECLARE @ParentFolderId UNIQUEIDENTIFIER = CASE	WHEN @ReferenceTypeName = 'TaxAllowanceProofs' THEN (SELECT Id FROM Folder WHERE StoreId = @StoreId AND InActiveDateTime IS NULL AND FolderName = 'Tax allowance proofs')
															   END
