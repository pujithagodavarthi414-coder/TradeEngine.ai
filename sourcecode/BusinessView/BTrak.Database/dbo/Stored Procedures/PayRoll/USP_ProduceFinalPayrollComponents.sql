CREATE PROCEDURE [dbo].[USP_ProduceFinalPayrollComponents]
(
...
BEGIN
	...
	BEGIN
		...
		SELECT TOP 1 @RemainingLeaves = EncashedLeaves FROM #Payroll WHERE EmployeeId = @EmployeeId 
...
--EXEC USP_ProduceFinalPayrollComponents '1558A8BC-D112-4FA6-AF52-BD72BBE90F5B',NULL,NULL,'2020-05-01','2020-05-31',NULL,NULL,'[{"EmployeeNumber":"test123","EmployeeName":"Peter","LossOfPay":2,"EncashedLeaves":0},{"EmployeeNumber":"branch 123","EmployeeName":"Test","LossOfPay":0,"EncashedLeaves":2}]'