CREATE PROCEDURE [dbo].[USP_UpsertCandidateFiles]
(
   @FilesXML XML = NULL,
        ...
        BEGIN
		   ...
		   ELSE
            BEGIN
					...
					BEGIN
						EXEC [USP_UpsertFile] @FilesXML = @FilesXML,@FolderId = @RecruitmentParentFolderId,@StoreId= @StoreId,@ReferenceId = @ReferenceId,@ReferenceTypeId = @ReferenceTypeId, @OperationsPerformedBy = @OperationsPerformedBy, @IsFromFeedback = NULL,@IsDuplicatesAllowed = 1
					END
					ELSE
						BEGIN
