...
{
    public class GenerateFeatureProcedureScrpt
    {
        public void FeatureProcedureScrpts()
        {
            var lastLookup = 0;
            var accessAll = false;
            var outputFilePath = @"..\..\USP_ExecuteFeatureProcedureScript.sql";
            var outputFilePathCopyTo = @"..\..\..\BTrak.Database\dbo\Stored Procedures\Common\USP_ExecuteFeatureProcedureScript.sql";
