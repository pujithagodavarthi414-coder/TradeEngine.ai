...
namespace BTrak.Common
{
    public class ValidationMessages
    {
        ...
        public static string ExceptionGetFormFieldData = LangText.ExceptionGetFormFieldData;
        ...
        public const string ExceptionGetClientTypes = "Get Client types could not be done. Please contact administrator.";
        ...
        public static string ExceptionUpsertLeadTemplate = LangText.ExceptionUpsertLeadTemplate;
        public static string ExceptionSearchLeadTemplate = LangText.ExceptionSearchLeadTemplate;
        public static string NotEmptyFormName = LangText.NotEmptyFormName;
        public static string FormNameLengthExceeded = LangText.FormNameLengthExceeded;
        public static string ExceptionUpsertGRD = LangText.ExceptionUpsertGRD;
        public static string ExceptionGetGRD = LangText.ExceptionGetGRD;
        public static string NotEmptyName = LangText.NotEmptyName;

        public static string ExceptionUpsertSite = LangText.ExceptionUpsertSite; 
        public static string ExceptionGetSite = LangText.ExceptionGetSite; 
        public static string NotEmptySiteName = LangText.NotEmptySiteName; 
        public static string SiteNameLengthExceeded = LangText.SiteNameLengthExceeded;

        public static string ExceptionUpsertGrERomande = LangText.ExceptionUpsertGrERomande;
        public static string ExceptionGetGrERomande = LangText.ExceptionGetGrERomande;

        public static string NotEmptySiteId = LangText.NotEmptySiteId;
        public static string NotEmptyGrdId = LangText.NotEmptyGrdId;
        public static string NotEmptyBankId = LangText.NotEmptyBankId;
        public static string NotEmptyMonth = LangText.NotEmptyMonth;
        public static string NotEmptyTerm = LangText.NotEmptyTerm;
        public static string NotEmptyYear = LangText.NotEmptyYear;
        public static string NotEmptyProduction = LangText.NotEmptyProduction;
        public static string NotEmptyReprise = LangText.NotEmptyReprise;
        public static string NotEmptyFacturation = LangText.NotEmptyFacturation;
        public static string NotEmptyGridInvoice = LangText.NotEmptyGridInvoice;
        public static string NotEmptyGridInvoiceDate = LangText.NotEmptyGridInvoiceDate;
        public static string NotEmptyHauteTariff = LangText.NotEmptyHauteTariff;
        public static string NotEmptyBasTariff = LangText.NotEmptyBasTariff;
        public static string NotEmptyDistribution = LangText.NotEmptyDistribution;
        public static string NotEmptyGreFacturation = LangText.NotEmptyGreFacturation;
        public static string NotEmptyAdministrationRomandeE = LangText.NotEmptyAdministrationRomandeE;
        public static string NotEmptyAutoCTariff = LangText.NotEmptyAutoCTariff;
        public static string ExceptionUpsertEntryFormField = LangText.ExceptionUpsertEntryFormField;
        public static string ExceptionGetEntryFormField = LangText.ExceptionGetEntryFormField;
        public static string ExceptionUpsertEntryFormFieldTypes = LangText.ExceptionUpsertEntryFormFieldTypes;
        public static string ExceptionGetEntryFormFieldTypes = LangText.ExceptionGetEntryFormFieldTypes;
        public static string NotEmptyDisplayName = LangText.NotEmptyDisplayName;
        public static string NotEmptyEntryFieldName = LangText.NotEmptyFieldName;
        public static string NotEmptyFieldTypeName = LangText.NotEmptyFieldTypeName;
        public static string DisplayNameNotExceeded = LangText.DisplayNameNotExceeded;
        public static string FieldNameNotExceeded = LangText.FieldNameNotExceeded;
        public static string FieldTypeNameNotExceeded = LangText.FieldTypeNameNotExceeded;
        public static string ExceptionGetGreRomandeHistory = LangText.ExceptionGetGreRomandeHistory;
        public static string ExceptionUpdateGreRomandeHistory = LangText.ExceptionUpdateGreRomandeHistory;
        public static string ExceptionUpsertMessageFieldType = LangText.ExceptionUpsertMessageFieldType;
        public static string ExceptionGetMessageFieldType = LangText.ExceptionGetMessageFieldType;
        public static string NotEmptyDisplayText = LangText.NotEmptyDisplayText;
        
        public static string ExceptionUpsertCreditNote = LangText.ExceptionUpsertCreditNote;
        public static string ExceptionGetCreditNote = LangText.ExceptionGetCreditNote;
        public static string ExceptionUpsertMasterAccount = LangText.ExceptionUpsertMasterAccount;
        public static string ExceptionGetMasterAccounts = LangText.ExceptionGetMasterAccounts;
        public static string ExceptionUpsertExpenseBooking = LangText.ExceptionUpsertExpenseBooking;
        public static string ExceptionGetExpenseBookings = LangText.ExceptionGetExpenseBookings;
        public static string ExceptionUpsertPaymentReceipt = LangText.ExceptionUpsertPaymentReceipt;
        public static string ExceptionGetPaymentReceipts = LangText.ExceptionGetPaymentReceipts;

        public static string GetSCOException = LangText.GetSCOException;
        public static string UpsertSCOException = LangText.UpsertSCOException;
        public static string NotEmptyLeadSubmissionId = LangText.NotEmptyLeadSubmissionId;
        public static string NotZeroCredits = LangText.NotZeroCredits;
        
        public static string NotEmptyContractNumber = LangText.NotEmptyContractNumber;
        public static string NotEmptyContractDateFrom = LangText.NotEmptyContractDateFrom;
        public static string NotEmptyContractDateTo = LangText.NotEmptyContractDateTo;
        public static string PriceShouldBeGreaterThanZero = LangText.PriceShouldBeGreaterThanZero;
        public static string QuantityShouldBeGreaterThanZero = LangText.QuantityShouldBeGreaterThanZero;
        public static string ContractDatesShouldBeCorrect = LangText.ContractDatesShouldBeCorrect;
        public static string ShipmentNumberRequired = LangText.ShipmentNumberRequired;
        public static string DischargePortIsRequired = LangText.DischargePortIsRequired;
        public static string LoadPortIsRequired = LangText.LoadPortIsRequired;
        public static string PortsShouldBeDifferent = LangText.PortsShouldBeDifferent;
        public static string ShipmentQuantityRequired = LangText.ShipmentQuantityRequired;
        public static string PurchaseShipmentBlIdRequired = LangText.PurchaseShipmentBlIdRequired;
        public static string PurchaseShipmentIdRequired = LangText.PurchaseShipmentIdRequired;
        public static string ShipmentQuantitiesShouldBeLessThanContractQuantity = LangText.ShipmentQuantitiesShouldBeLessThanContractQuantity;
        public static string GetClientKycException = LangText.GetClientKycException;
        public static string GetLegalEntityException = LangText.GetLegalEntityException;
        public static string UpsertLegalEntityEception = LangText.UpsertLegalEntityEception;
        
        public static string ExceptionUpsertClientTypes = LangText.ExceptionUpsertClientTypes;
        public static string ExceptionReOrderClientTypes = LangText.ExceptionReOrderClientTypes;
        public static string ExceptionGetShipToAddresses = LangText.ExceptionGetShipToAddresses;
        public static string ExceptionUpsertShipToAddress = LangText.ExceptionUpsertShipToAddress;
        public static string UpsertKycStatusException = LangText.UpsertKycStatusException;
        public static string GetKycStatusException = LangText.GetKycStatusException;
        public static string UpsertCompanySettingsException = LangText.UpsertCompanySettingsException;
        public static string GetClientSettingsException = LangText.GetClientSettingsException;
        public static string GetTemplateConfigurationException = LangText.GetTemplateConfigurationException;
        public static string UpsertTemplateConfigurationException = LangText.UpsertTemplateConfigurationException;
        public static string GetHtmlTagsException = LangText.GetHtmlTagsException;
        public static string GetContractStatusException = LangText.GetContractStatusException;
        public static string UpsertContractException = LangText.UpsertContractException;
        public static string UpsertInvoiceException = LangText.UpsertInvoiceException;
        public static string GetInvoiceStatusException = LangText.GetInvoiceStatusException;
        public static string UpsertRFQRequest = LangText.UpsertRFQRequestException;
        public static string GetToleranceException = LangText.GetToleranceException;
        public static string UpsertToleranceException = LangText.UpsertToleranceEception;        
        public static string GetPaymentConditionException = LangText.GetPaymentConditionException;
        public static string UpsertPaymentConditionException = LangText.UpsertPaymentConditionEception;
        public static string GetTemplateTypeException = LangText.GetTemplateTypeException;
        public static string UpsertPortCategoryException = LangText.UpsertPortCategoryException;
        public static string GetAllPortCategoryException = LangText.GetAllPortCategoryException;
        public static string DynamicModuleNameExists = "Dynamic module with this name already exists";
    }
}