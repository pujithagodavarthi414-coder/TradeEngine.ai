        ...
        public override void RewritePath(HttpContext context)
        {
            ...
            if (this.streamCachedImage)
            {
                ...
                catch (WebException exception)
                {
                    ...
                    if (exception.Response != null && (((HttpWebResponse)exception.Response).StatusCode == HttpStatusCode.NotModified
                        || exception.Response.ResponseUri.AbsoluteUri.Equals(this.cachedRewritePath, StringComparison.OrdinalIgnoreCase)))
                    {
