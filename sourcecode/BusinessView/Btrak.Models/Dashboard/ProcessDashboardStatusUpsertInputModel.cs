...
{
    public class ProcessDashboardStatusUpsertInputModel : InputModelBase
    {
        public ProcessDashboardStatusUpsertInputModel() : base(InputTypeGuidConstants.ProcessDashboardStatusUpsertInputCommandTypeGuid)
        {
        }
