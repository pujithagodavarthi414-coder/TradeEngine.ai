...
{
    public class ConfigurationSettingUpsertInputModel : InputModelBase
    {
        public ConfigurationSettingUpsertInputModel() : base(InputTypeGuidConstants.ConfigurationSettingsUpsertInputCommandTypeGuid)
        {
        }
