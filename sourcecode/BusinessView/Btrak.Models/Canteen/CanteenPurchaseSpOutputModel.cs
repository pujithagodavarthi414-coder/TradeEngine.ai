...
{
    public class CanteenPurchaseSpOutputModel : InputModelBase
    {
        public CanteenPurchaseSpOutputModel() : base(InputTypeGuidConstants.CanteenPurchaseOutputModelCommandTypeGuid)
        {
        }
