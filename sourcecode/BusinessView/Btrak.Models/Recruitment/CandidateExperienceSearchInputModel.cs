...
{
    public class CandidateExperienceSearchInputModel : SearchCriteriaInputModelBase
    {
        public CandidateExperienceSearchInputModel() : base(InputTypeGuidConstants.CandidateExperienceSearchInputCommandTypeGuid)
        {
        }
