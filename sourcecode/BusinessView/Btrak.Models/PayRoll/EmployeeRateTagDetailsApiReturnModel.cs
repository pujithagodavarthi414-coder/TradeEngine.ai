...
{
    public class EmployeeRateTagDetailsApiReturnModel
    {
        ...
        public Guid? RoleBranchConfigurationId { get; set; }
        ...
        public override string ToString()
        {
            ...
            stringBuilder.Append(", DatePeriod = " + DatePeriod);
            stringBuilder.Append(", IsInHerited = " + IsInHerited);
            stringBuilder.Append(", IsOverRided = " + IsOverRided);
            stringBuilder.Append(", RoleBranchConfigurationId = " + RoleBranchConfigurationId);
