...
{
    public class UserStoriesForAllSprints : SearchCriteriaInputModelBase
    {
        public UserStoriesForAllSprints() : base(InputTypeGuidConstants.SprintSearchCriteriaInputCommandTypeGuid)
        {
        ...
        public override string ToString()
        {
            ...
            stringBuilder.Append("ProjectId = " + ProjectIds);
            stringBuilder.Append(", SprintId = " + SprintId);
            stringBuilder.Append(", UserStoryId = " + UserStoryId);
            stringBuilder.Append(", OwnerUserId = " + OwnerUserIds);
            stringBuilder.Append(", SprintResponsiblePersonId = " + SprintResponsiblePersonIds);
            stringBuilder.Append(", UserStoryStatusId = " + UserStoryStatusIds);
            stringBuilder.Append(", SprintStatusId = " + SprintStatusIds);
            ...
            stringBuilder.Append(", WorkItemTags = " + WorkItemTags);
            stringBuilder.Append(", IsArchivedSprint = " + IsArchivedSprint);
