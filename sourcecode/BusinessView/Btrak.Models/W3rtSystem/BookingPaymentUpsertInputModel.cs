...
{
    public class BookingPaymentUpsertInputModel : InputModelBase
    {
        public BookingPaymentUpsertInputModel() : base(InputTypeGuidConstants.BookingPaymentUpsertInputCommandTypeGuid)
            {
            }
