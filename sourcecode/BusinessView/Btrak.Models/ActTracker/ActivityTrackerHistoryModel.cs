...
{
    public class ActivityTrackerHistoryModel : SearchCriteriaInputModelBase
    {
        public ActivityTrackerHistoryModel() : base(InputTypeGuidConstants.ActivityTrackerHistoryCommandTypeGuid)
        {
        ...
        public override string ToString()
        {
            ...
            stringBuilder.Append("SelectedCategory = " + SelectedCategory);
