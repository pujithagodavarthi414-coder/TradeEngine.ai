...
{
    public class EmployeeEmergencyContactDetailsInputModel : InputModelBase
    {
        public EmployeeEmergencyContactDetailsInputModel() : base(InputTypeGuidConstants.EmployeeEmergencyContactDetailInputCommandTypeGuid)
        {
        }
