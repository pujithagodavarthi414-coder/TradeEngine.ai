...
namespace PDFHTMLDesignerModels.PDFDocumentEditorModel
{
    public class DataSourceDetailsInputModel
    {
        ...
        public DataSorceParams[] DataSorceParamsType { get; set; }
        public DataSourceDummyParamValues[] DataSourceDummyParamValues { get; set; }
    ...
    public class MongoQueryInputModel
    {
        ...
        public string MongoQuery { get; set; }
        public DataSorceParams[] DataSorceParamsType { get; set; }
        public DataSourceDummyParamValues[] DataSourceParamValues { get; set; }
