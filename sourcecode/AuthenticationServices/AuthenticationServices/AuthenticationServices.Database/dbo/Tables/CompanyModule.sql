...
ALTER TABLE [dbo].[CompanyModule]  WITH NOCHECK ADD  CONSTRAINT [FK_Company_CompanyModule_CompanyId] FOREIGN KEY(CompanyId)
REFERENCES [dbo].[Company] ([Id])
GO

ALTER TABLE [dbo].[CompanyModule] CHECK CONSTRAINT [FK_Company_CompanyModule_CompanyId]
GO
