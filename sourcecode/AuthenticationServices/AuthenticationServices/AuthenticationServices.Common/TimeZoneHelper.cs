...
namespace AuthenticationServices.Common
{
    public class TimeZoneHelper
    {
        ...
        public static UserTimeZoneDetails GetUserCurrentTimeByIp(string ipAddress, string timeZoneApi, string timeZoneApiFree)
        {
            LoggingManager.Debug("started fetching user current time with " + ipAddress);

            var userTime = GetUserTimeZoneByIp(ipAddress, timeZoneApi, timeZoneApiFree);
            ...
            if (userTime != null)
            {
                ...
                LoggingManager.Debug("Timezone details for country code,country name,offset,timezone " + userTime.CountryCode + userTime.GMTOffset + userTime.TimeZone + userTime.CountryName);
        ...
        public static TimeZoneDetailsModel GetUserTimeZoneByIp(string ipAddress,string timeZoneApi,string timeZoneApiFree)
        {
            try
            {
                ...
                using (var webClient = new System.Net.WebClient())
                {
                    ...
                    //var timeZoneApi = ConfigurationManager.AppSettings["TimeZoneApi"];//_appSettings.TimeZoneApi;//CloudConfigurationManager.GetSetting("TimeZoneApi");
                    //var timeZoneApiFree = ConfigurationManager.AppSettings["TimeZoneApiFree"];//_appSettings.TimeZoneApiFree;//CloudConfigurationManager.GetSetting("TimeZoneApiFree");
                    try
                    {
                    ...
                    LoggingManager.Debug("Getting timezone related details not fetched for ipaddress json " + response);

                    LoggingManager.Debug("Getting timezone related details not fetched for ipaddress " + responseData.ToString());
