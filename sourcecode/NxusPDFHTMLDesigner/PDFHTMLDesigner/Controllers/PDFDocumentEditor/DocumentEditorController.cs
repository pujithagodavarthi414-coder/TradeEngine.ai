...
namespace SyncfusionDocument.Controllers
{
    ...
    public class DocumentEditorController : AuthTokenApiController
    {
        ...
        {
            string name = "E:\\Editor\\syncfusion\\C#_backend\\SimpleCRUDAppNetCore-master\\SFDT_Files\\sample.sfdt";
            //string name = data.FileName;
            string format = RetrieveFileType(name);
            if (string.IsNullOrEmpty(name))
            {
