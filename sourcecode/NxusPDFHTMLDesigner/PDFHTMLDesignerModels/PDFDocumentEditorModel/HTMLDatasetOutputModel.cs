...
namespace PDFHTMLDesignerModels.HTMLDocumentEditorModel
{
    ...
    public class TemplateWithDataSourcesOutputModel
    {
        public List<PDFDesignerDatasetOutputModel> DataSources { get; set; }
        public Guid? GenericFormSubmittedId { get; set; }
        public TemplateOutputModel  Template { get; set; }
